...
\begin{itemize}
\item \PurePy, a pure functional subset of Python, presented as a versioned standard with a formal grammar and
well-formedness rules based on a definite-assignment analysis;
\item an operational semantics that preserves the meaning of well-formed \PurePy programs in Python;
\item a reference checker that decides membership of the subset, validated by a conformance test suite
exercised on CPython, PyPy, GraalPy, and Pyodide.
\end{itemize}

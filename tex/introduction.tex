...
definite-assignment analysis, and an operational semantics that agrees with Python on every run it defines. A reference checker decides well-formedness, and a conformance test suite exercises the
standard against CPython, \Deleted{PyPy,} GraalPy, and Pyodide. The guarantee is precise: well-formedness is decidable, and
...
a definite-assignment analysis (\secref{well-formedness}) and an operational semantics that agrees with Python on
...
exercised on CPython, \Deleted{PyPy,} GraalPy, and Pyodide (\secref{reference-impl});

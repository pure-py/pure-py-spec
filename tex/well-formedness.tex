...
Well-formedness decides which programs \PurePy accepts. The block and expression rules rest on a
definite-assignment analysis; the pattern rules enforce linearity and reachability; and the module rules
govern imports and class declarations. The section follows the syntax of \secref{syntax}, taking patterns,
then blocks and expressions, then modules and programs, and \secref{opsem} gives each of these a dynamic
counterpart.

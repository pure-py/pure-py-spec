...
% Listings style for Python (force pure monospace everywhere)
...
% Easy-to-use Python environment and command
\lstnewenvironment{python}[1][]{\lstset{style=base16python,#1}}{}
\newcommand{\pyinline}[1]{\lstinline[style=base16python]!#1!}

...
sit outside the subset discipline: Coconut~\cite{coconut} is a functional language that compiles to Python, and
functional pipelines have been proposed for scientific computation in Python~\cite{zhang2024}, alongside
index-free data-processing libraries such as Polars.\footnote{\url{https://docs.pola.rs/}} Although \PurePy does not aim to make Python
...
such as Prism~\cite{prism}, are relevant to the structured effects \PurePy may add in a later release.

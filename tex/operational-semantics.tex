...
Block evaluation $\rho\Added{{} : \Gamma}, b \Rightarrow r$ is given in \figref{eval-block-outcome}. Function definitions delimit
...
Expression evaluation $\rho\Added{{} : \Gamma}, e \Rightarrow o$ (\figrefTwo{eval-outcome}{eval-outcome-ctd}) yields an

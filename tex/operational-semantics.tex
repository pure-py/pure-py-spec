...
the scope of sequential-composition effects, so as black boxes functions are always pure. We write $\rho, b \evalsTo o$ for the outcome a block yields as a
value (\figref{eval-value}), $\val{\pyinline{None}}$ where it falls off the end.

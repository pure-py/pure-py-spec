...
$\primVal{\primFn}$ is an implementation-supplied function whose meaning $\primFn$ is a partial map from
arguments to outcomes. A call to one has outcome $\primFn(\seq{u})$ for arguments $\seq{u}$, and no

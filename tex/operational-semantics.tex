...
the scope of sequential-composition effects, so as black boxes functions are always pure. The metafunction $\unwrap$ (\figref{eval-aux}) turns a block's
result into the outcome of a call, $\val{\pyinline{None}}$ where the block falls off the end.

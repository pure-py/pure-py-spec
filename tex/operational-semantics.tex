...
Expression evaluation $\rho, e \Rightarrow v$ is given in \figref{eval-expr}\Added{, with the compound forms
in \figref{eval-expr-compound}. The strict operators are given by partial metafunctions $\hat{\odot}$ and

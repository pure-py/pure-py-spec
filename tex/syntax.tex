...
$q$, together with \pyinline{__name__}, to \Replaced{an implementation-defined value}{implementation-defined values}.\Deleted{Its context is whatever types that

...
\begin{AddedBlock}
\noindent A module attribute reference is well-formed only when it resolves to a definitely assigned member (rule \ruleName{attr-module-member}) or to an imported submodule (rule \ruleName{attr-submodule}); see the examples of \S\ref{sec:uninitialised-members}.
\end{AddedBlock}

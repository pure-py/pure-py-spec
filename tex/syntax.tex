...
statically. First, a member that is not definitely assigned may end a run without ever being assigned,
leaving the module without the attribute. Here \pyinline{b} is \pyinline{False}, so \pyinline{x} is never
assigned:
\vspace{-\medskipamount}

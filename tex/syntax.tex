...
\item a \emph{module reference}, for a fully-qualified module name $q$: \Replaced{either a \emph{stub} $\exMod{q}$, or a \emph{loaded} reference $\exModF{q}{\Gamma}$, which also carries the member context $\Gamma$ of $q$}{$\modEntry{q}$};

...
In Python, an attribute of a module can be missing at runtime in two ways, a reference then raising
\pyinline{AttributeError}; \PurePy rejects both statically. First, the run may never assign the member:
\vspace{-\medskipamount}

...
construction.} \Added{A module with submodules is a \emph{package}.} The map $\mathcal{M}$ is fixed and ambient in all
...
import forms load their target, together with its proper prefixes, the packages that enclose it
(\figref{well-formed-imports}). A plain import also records each of these packages as a member of its

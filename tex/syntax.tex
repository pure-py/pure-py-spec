...
\pyinline{AttributeError} & \leavevmode{\color{blue}Always: a module attribute reference must resolve to a definitely assigned member.} {\color{deletedgray}The attribute is a module member that is definitely assigned, or a submodule among the referring module's dependencies.} & \figref{well-formed-expr} \\[1mm]

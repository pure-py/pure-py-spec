...
In Python, a module attribute reference raises \pyinline{AttributeError} in two situations; \PurePy
rejects both statically. First, the run may never assign the member:
\vspace{-\medskipamount}

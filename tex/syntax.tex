...
\Added{Complementing the list above (programs Python runs that \PurePy rejects), well-formedness partly
precludes the classes of Python runtime error listed in \figref{prevented-errors}. Errors from ill-typed
...
\hline
\end{tabular}
\caption{Python errors partly precluded by well-formedness}

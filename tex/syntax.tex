...
(\figref{well-formed-imports}), the exemption is the bound $m$ on the loads-to judgement, a possibly-empty
module name whose prefixes the walk skips: $\varepsilon$ for an import, the importing module for a
from-import.} Program well-formedness (\figref{well-formed-module}) requires the

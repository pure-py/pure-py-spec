...
\figref{predefined}, \Replaced{whose bodies are implementation-defined and whose contexts and environments are given directly (Definition~\ref{def:predefined})}{each defining exactly its listed members}, and is prefix-closed: the parent of any module in $\dom(\mathcal{M})$ is itself in

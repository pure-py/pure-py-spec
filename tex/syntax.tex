...
proper prefix of the target and links each module into its parent (the links judgement), so that the
...
a prefix that encloses the importing module itself, because such a module may still be loading when the

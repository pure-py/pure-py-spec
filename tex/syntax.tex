...
\item a \emph{module reference}, for a fully-qualified module name $q$: either a \emph{stub} $\modStub{q}$, or \emph{loaded} reference $\modLoaded{q}{\Gamma}$, which also carries a context $\Gamma$ specifying the members of $q$; a context in this role is called the \emph{signature} of $q$;

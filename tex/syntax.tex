...
\Gamma$ (\figref{well-formed-env}), where $\rho$ binds}{an environment binding} the members listed for
$q$, together with \pyinline{__name__}, to implementation-defined values.\Added{ A member that denotes a function is

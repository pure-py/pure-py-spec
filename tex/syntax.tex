...
\item a \emph{module reference}, for a fully-qualified module name $q$: either a \emph{stub} $\exMod{q}$, or \emph{loaded} reference $\exModF{q}{\Gamma}$, which also carries the member context $\Gamma$ of $q$;

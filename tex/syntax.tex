...
p.q'$ for some $q'$, and $\properPrefixOf$ for the strict order. The metafunctions $\rootOf$ and
$\submodules$ are collected, with the class-related metafunctions, in
Appendix~\ref{sec:aux-modules}.}{The metafunction $\assignsS$ extends by union from individual statements to
...
(\figref{well-formed-module}) requires every module of the program to be well-formed. The rules are

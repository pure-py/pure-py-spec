...
\item a \emph{module reference}, for a fully-qualified module name $q$: either a \emph{stub} $\exMod{q}$, or a \emph{loaded} reference $\exModF{q}{\Gamma}$, which also carries the member context $\Gamma$ of $q$;
...
\theta \runion \theta' &= \theta' \quad (\text{otherwise})
\end{align*}}
\end{definition}

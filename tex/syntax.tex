...
\item a \emph{module reference}, for a fully-qualified module name $q$: either a \emph{stub} $\stub{q}$, or \emph{loaded} reference $\loaded{q}{\Gamma}$, which also carries the member context $\Gamma$ of $q$;
...
{\small
\begin{align*}
\loaded{q}{\Gamma} \extend \loaded{q}{\Gamma'} &= \loaded{q}{\Gamma \extend \Gamma'} \\
\stub{q} \extend \loaded{q}{\Gamma} = \loaded{q}{\Gamma} \extend \stub{q} &= \loaded{q}{\Gamma} \\

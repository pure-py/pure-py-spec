...
\begin{AddedBlock}
\noindent A module attribute reference is well-formed only when it resolves to a definitely assigned member (rule \ruleName{attr-module}); see \S\ref{sec:uninitialised-members}.
\end{AddedBlock}
...
Rule \ruleName{attr-module} rejects these references: \pyinline{x} is not definitely assigned in
\pyinline{lib}, and \pyinline{a.b} is a stub, so neither resolves.
\end{AddedBlock}

...
\Added{The grammar of \PurePy is an abstract syntax, and its metavariables range over values rather than
over source text: $n$ is a number rather than a numeral, and $w$ is a string rather than a lexeme. How
source text becomes abstract syntax follows Python. \todo{Say which of Python's lexical rules \PurePy
narrows.}}

...
member listed for $q$ to the value \figref{predefined} gives it.}{an environment binding each member listed for $q$, together with
\pyinline{__name__}, to implementation-defined values. Its context is whatever types that environment
(\figref{well-formed-env}).}
\end{definition}

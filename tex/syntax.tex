...
$q$, together with \pyinline{__name__}, to \Replaced{an implementation-defined value, or to a primitive $\primVal{\primFn}$ where $\primFn$ maps a
sequence of values to an outcome}{implementation-defined values}.\Deleted{Its context is whatever types that

...
(\figref{well-formed-imports}), the exemption is the bound on the loads-to judgement, whose prefixes the
walk skips: $\varepsilon$ for an import, the importing module for a from-import.} Program well-formedness (\figref{well-formed-module}) requires the

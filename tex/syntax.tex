...
$q$, together with \pyinline{__name__}, to implementation-defined values. \Replaced{Its context is the $\Gamma$ for
which $\vdash \mathcal{P}(q) : \Gamma$}{Its context is whatever types that environment} (\figref{well-formed-env}).
\end{definition}

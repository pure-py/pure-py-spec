...
\figref{predefined}, each defining exactly its listed members, and is prefix-closed: the parent of any module in $\dom(\mathcal{M})$ is itself in
...
A dataclass declaration counts as an assignment of its class name for these definitions, though

...
$q$, together with \pyinline{__name__}, to \Replaced{the primitive values $\primVal{q.x}$}{implementation-defined values}.\Deleted{Its context is whatever types that

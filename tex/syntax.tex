...
\Added{A dataclass declaration counts as an assignment of the class name here: if a function captures a
class name that a later declaration re-declares, the function called in Python would see the newer class,
so such programs are rejected on the same grounds.}

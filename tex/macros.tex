...
\newcommand*{\exConstruct}[2]{#1(#2)}
\newcommand*{\patClass}[2]{#1(#2)}
\newcommand*{\patClassKeyword}[2]{#1(#2)}
...
\newcommand*{\exClosure}[4][]{\langle#2, #3, #4\rangle_{#1}}
\newcommand*{\exDefClosure}[4][]{\langle#2, #3, #4\rangle_{#1}}
\newcommand*{\exObj}[3]{\mathsf{Obj}_{#1}(#2, #3)}
\newcommand*{\exMod}[2]{\mathsf{Mod}_{#1}(#2)}
...
\newcommand*{\clsEntry}[4]{\langle #2, #3, #4 \rangle_{#1}}
...
\newcommand*{\resolveModule}{\mathrm{resolve\text{-}module}}

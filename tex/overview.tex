...
\pyinline{nan} comparison via container equality & Elements compared by identity before equality, so identical NaNs match but distinct ones do not & \replaced{Undefined when both elements are \pyinline{nan}}{Equality undefined} & Dynamically \\
\hline
\end{tabular}

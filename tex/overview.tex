...
\Added{A program is well-formed when it passes \PurePy's static checks. Semantic validity is about a single run rather than about the program, because a run

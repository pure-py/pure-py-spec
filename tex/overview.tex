...
\PurePy is a subset of Python: every well-formed program is a valid Python program, and if \PurePy
...
\pyinline{nan} comparison via container equality & Elements compared by identity before equality, so identical NaNs match but distinct ones do not & Equality undefined \\
\hline
\end{tabular}

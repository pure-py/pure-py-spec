...
\pyinline{==} and \pyinline{!=} & Compare any two operands, giving \pyinline{False} when unrelated & Undefined between, say, a number and a string, or a list and a tuple; only \pyinline{None} compares with anything \\[1mm]
...
Int and float as distinct types & \issue{156} \\
\end{tabular}

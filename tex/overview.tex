...
\begin{tikzpicture}[font=\footnotesize, rounded corners=4pt]
  ...
  \draw[black!45, line width=0.7pt] (0,0) rectangle (13.4,7.8);
  \draw[cyan!55!black, line width=0.7pt] (1.5,1.5) rectangle (9.0,6.3);
  \draw[dashed, cyan!55!black, line width=0.7pt] (4.8,0.5) rectangle (12.95,7.3);
  \draw[green!45!black, line width=0.7pt] (5.2,2.5) rectangle (8.8,5.2);

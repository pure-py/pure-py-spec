...
stock Python interpreter will simply produce the Python result. The conformance suite is organised the same
way (\secref{reference-impl}).}
...
\end{tikzpicture}
\caption{Python programs and runs, classified by \PurePy. The shaded region is where Python raises}
\label{fig:taxonomy}
\end{figure}

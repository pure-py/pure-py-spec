...
\begin{tikzpicture}[font=\footnotesize, rounded corners=4pt]
  ...
  \node[align=center] at (2.4,0.85) {Python would raise (\figref{prevented-errors})};
  \node[align=center] at (11.0,3.9) {Excluded by design\\(\figref{coercions})};
  \node[align=center] at (3.2,3.9) {Python runtime error\\\PurePy runtime error};

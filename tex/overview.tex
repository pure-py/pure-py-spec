...
dataclass, and a dataclass body declares fields and nothing else. A class cannot supply its own meaning for
subscripting, iteration, equality or membership, which have the fixed meanings given in \secref{opsem}.}{Only dataclasses are supported, so

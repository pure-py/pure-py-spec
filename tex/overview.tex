...
A stricter design would drop printing and decline to say when failures occur. Evaluation order would then
be unobservable, and the semantics could leave unspecified, for example, the order in which modules load.
We reject this alternative for two reasons. First, errors should occur at determinate points; a program

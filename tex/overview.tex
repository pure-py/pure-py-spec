...
\begin{tikzpicture}[font=\footnotesize, rounded corners=4pt]
  \fill[black!45, fill opacity=0.13] (4.8,0.5) rectangle (12.95,7.3);
  \fill[black!45, fill opacity=0.13] (1.5,1.5) rectangle (9.0,6.3);
  \fill[black!45, fill opacity=0.13] (5.2,2.5) rectangle (8.8,5.2);

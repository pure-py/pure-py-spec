...
\todo{Sequence patterns are a defect, not an exclusion: a list pattern applied to a tuple fails to match
rather than getting stuck, so a later case runs and the two languages disagree (\issue{151}).}

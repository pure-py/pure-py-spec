...
\todo{Sequence patterns break this: a list pattern applied to a tuple fails to match rather than getting
stuck, so a later case runs and the program means something different in the two languages. This is a
defect rather than a designed exclusion (\issue{151}).}

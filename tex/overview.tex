...
Sequence patterns & List patterns match tuples, and tuple patterns lists & List patterns match only lists, tuple patterns only tuples & Neither; results differ (\issue{151}) \\[1mm]

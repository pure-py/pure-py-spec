...
Dictionary keys & \Replaced{Any hashable value}{Any hashable values}, with \pyinline{1}, \pyinline{1.0} and \pyinline{True} equivalent as keys\added{; a subscript with an absent key raises \pyinline{KeyError}, or \pyinline{TypeError} if unhashable} & Strings only\added{, in literals and in subscripts} & Statically in patterns, dynamically in expressions \\[1mm]

...
under Python and not under \PurePy. Sequence patterns are the exception: a list pattern applied to a tuple
fails to match rather than getting stuck, so a later case runs and the program means something different
in the two languages.}{Python accepts several implicit coercions and lax matches that are convenient but a recognised source of error,

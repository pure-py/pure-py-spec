...
statements anywhere in the module body. Loading a module $M$ also requires loading each of its
\emph{parents} (proper prefixes of $M$); the program-level dependency graph used for cycle-checking
combines $\imports$ with $\parents$ edges.

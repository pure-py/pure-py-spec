...
Class contexts $\Lambda$ are finite maps from class names to pairs $(F, C)$, where $F$ is a set of field
names and $C$ names the base class (or $\bot$ for no base). Metavariables $C$ and $B$ range over class names.

...
The metafunctions $\imports$ and $\assignsS$ extend from individual statements to blocks and module bodies by union. The metafunction $\classes$ (\figref{modules}) extends similarly, provided the class names declared are distinct. The metafunction $\parents$ collects the proper prefixes of a

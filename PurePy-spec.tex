...
For any $q \in \dom(\mathcal{M})$, the \emph{initial variable context} of $q$ is $\Gamma_q^0 =
\set{\bind{\pymath{\_\_name\_\_}}{\statusDefAssigned}}$, and $\Gamma_{\pymath{builtins}}$ binds the names of the
predefined module \textup{\pyinline{builtins}} (\figref{predefined}).
\end{definition}
...
\figref{eval-load}. These use the initial environment $\rho_q^0 = \set{\bind{\pymath{\_\_name\_\_}}{v}}$, where

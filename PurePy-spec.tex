...
(\figref{syntax-stmt}) to \emph{modules} $m$, of which one is a distinguished \emph{main module} with name
$\pymath{\_\_main\_\_}$. $\mathcal{M}$ additionally always includes the predefined modules of

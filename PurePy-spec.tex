...
to be acyclic. \Added{The \emph{import closure} $I(q)$ of a module $q$ is the set of modules reachable from
$q$ in $G_{\mathcal{M}}$. Since imports precede statements, in Python every module in $I(q)$ is loaded before
any statement of $q$ runs.}

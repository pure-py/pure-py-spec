...
$b$ begins under the initial environment $\rho_M = \rho_{\pyinline{builtins}} \runion \set{\text{\pyinline{__name__}}
\mapsto v}$, where $v$ is \pyinline{"__main__"} if $M = E$ and the string literal corresponding to $M$ otherwise.
The environment $\rho_{\pyinline{builtins}}$ binds the names listed for \pyinline{builtins} in \figref{predefined}
to their values.

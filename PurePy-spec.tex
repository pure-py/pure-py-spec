...
\Added{Rule \ruleName{qualified-submodule} requires the submodule to be among the dependencies of the referring module $q_0$. This ensures it is loaded wherever the reference can be evaluated; Python raises \pyinline{AttributeError} on the attribute path of an unloaded submodule.}

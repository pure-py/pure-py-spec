...
\noindent Exports comprise the classes and variables a module defines, not modules, since a module name enters scope only via an import, which is a private dependency rather than part of the module's interface.

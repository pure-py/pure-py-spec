...
Suppose $\varnothing \vdash (\exAssign{\pymath{\_\_name\_\_}}{\nameOf(q)}) \cons \mathcal{M}(q) : \Delta$. Define the \emph{exports} of $q$ as $\Delta$, and the \emph{context} of $q$ as $\Gamma_q = \Delta \runion \set{\bind{x}{\modEntry{q.x}} \mid q.x \in \dom(\mathcal{M})}$.
\end{definition}

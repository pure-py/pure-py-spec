...
\hline
\pyinline{NameError}, \pyinline{UnboundLocalError} & \ruleName{var} (\figref{well-formed-expr}); branch merge in \ruleName{if}, \ruleName{if-else}, \ruleName{match} (\figref{well-formed}) & Definite assignment ensures a unique lexical referent, which is stricter (\S\ref{sec:assignment-as-definition}). \\[1mm]

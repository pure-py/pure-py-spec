...
The \emph{initial variable context} is $\Gamma^0 = \set{\bind{\pymath{\_\_name\_\_}}{\statusDefAssigned}}$, and
...
Suppose $\Gamma^0 \vdash \mathcal{M}(q) : \Delta$. Define the \emph{exports} of $q$ as $\Gamma_q = \set{\bind{\pymath{\_\_name\_\_}}{\statusDefAssigned}} \runion \Delta$.
\end{definition}

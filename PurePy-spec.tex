...
\item \emph{class entry}: a triple $(q, \vec{x}, c')$ of the defining module $q$, a sequence of distinct field names $\vec{x}$, and a base class $c'$ (or $\bot$ for no base); the entry bound to $c$ has fully-qualified name $q.c$.
\end{itemize}
\end{definition}

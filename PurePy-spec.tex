...
\item \emph{class entry} $\clsEntry{\Gamma}{q}{\vec{x}}{c'}$, recording the declaring context $\Gamma$, defining module $q$, a sequence of distinct field names $\vec{x}$, and a base class $c'$ (or $\bot$ for no base).
\end{itemize}
\end{definition}

...
\figref{predefined}: the names of the predefined module \pyinline{builtins}, available in every \PurePy
module without an explicit \pyinline{import}; and the variable \pyinline{__name__}, set per module to

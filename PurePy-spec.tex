...
For any $(M \mapsto b) \in \mathcal{M}$, $b$ is checked under the following per-module contexts:
\begin{enumerate}
\item variable context $\Gamma_M = \Gamma_{\textup{\pyinline{builtins}}} \runion
...
\item class context $\Lambda_M = \classes(b)$ (\figref{modules}).
\end{enumerate}
\end{definition}

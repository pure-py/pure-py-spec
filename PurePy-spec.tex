...
The \emph{initial variable context} is $\Gamma_0 = \set{\bind{\pymath{\_\_name\_\_}}{\statusDefAssigned}}$, and
...
Suppose $\Gamma_0 \vdash \mathcal{M}(q) : \Delta$. Define the \emph{exports} of $q$ as $\Gamma_q = \set{\bind{\pymath{\_\_name\_\_}}{\statusDefAssigned}} \runion \Delta$.
\end{definition}
...
\figref{eval-load}. These use the initial environment $\rho_0(q) = \set{\bind{\pymath{\_\_name\_\_}}{v}}$, where

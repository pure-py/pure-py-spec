...
A well-formed \PurePy program avoids the following classes of Python runtime error by construction. (The
previous section is the complementary list: programs Python runs that \PurePy rejects.) Errors from ill-typed

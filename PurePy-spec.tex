...
level and \pyinline{UnboundLocalError} inside a function when the unassigned path is taken. The analysis is
conservative: it also rejects programs in which every run assigns the variable before the reference, such as
the left-hand program of \S\ref{sec:contexts}.

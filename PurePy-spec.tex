...
where all variables are undefined. For a set of variables $S$, write $\statusDefAssigned(S)$ for the context
$\set{x : \statusDefAssigned \mid x \in S}$; similarly $\statusNotDefAssigned(S)$.

...
$\nameOf(\pymath{\_\_main\_\_}) = \pymath{"\_\_main\_\_"}$. \Added{A module body is a sequence of imports
...
imports precede statements, every module in $I$ is loaded before any statement of $q$ runs.}

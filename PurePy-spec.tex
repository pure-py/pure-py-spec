...
The \emph{initial variable context} is $\Gamma_{\pymath{\_\_name\_\_}} = \set{\bind{\pymath{\_\_name\_\_}}{\statusDefAssigned}}$, and
...
Suppose $\Gamma_{\pymath{\_\_name\_\_}} \vdash \mathcal{M}(q) : \Delta$. Define the \emph{exports} of $q$ as $\Gamma_q = \set{\bind{\pymath{\_\_name\_\_}}{\statusDefAssigned}} \runion \Delta$.
\end{definition}
...
\figref{eval-load}. These use the initial environment $\rho_{\pymath{\_\_name\_\_}}(q) = \set{\bind{\pymath{\_\_name\_\_}}{v}}$, where
$v$ is the string literal naming $q$, and the environment $\rho_{\pymath{builtins}}$ binding the names of
\figref{predefined}.

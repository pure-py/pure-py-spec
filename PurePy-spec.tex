...
\pyinline{TypeError} & A constructor must supply exactly the class's fields, and a class pattern must match the class's arity. Only excess sub-patterns are a Python error; too few is no error, just prohibited. & \figref{well-formed-expr}, \figref{well-formed-pat} \\
\hline
\end{tabular}

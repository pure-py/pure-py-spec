...
\pyinline{import}. In addition, each module receives a \emph{module-local} variable \pyinline{__name__}, set
by the import machinery to \pyinline{"__main__"} in the entry-point module and to the module's own name
otherwise.

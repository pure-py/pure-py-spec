...
A \PurePy execution context (or \emph{program}) is a finite set of modules, each identified by a
\emph{fully-qualified name}: a non-empty sequence of identifiers separated by dots, e.g. $x_1.x_2.\ldots.x_k$.
One module is designated as the entry point.
...
\pyinline{__name__}, set to \pyinline{"__main__"} if $m$ is the entry point and to the name of $m$ otherwise.

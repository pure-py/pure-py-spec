---
name: purepy-editor
description: Conventions for editing the PurePy spec and its GitHub issues; defers to the technical-authoring skill for prose style and to the github-issues skill for general issue, pull request and meeting conventions.
---

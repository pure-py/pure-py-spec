...
- Every clause names its participants. No pro-form whose referent lies in an earlier clause: "leaves none", "the others", "the same holds", "so does". Repeat the noun ("leaves an empty residual", "the remaining members") or restructure.

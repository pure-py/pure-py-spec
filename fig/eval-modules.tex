...
{
  \varnothing, \varnothing, \mathcal{M}(\pymath{\_\_main\_\_}) \Rightarrow \mu, \rho
}
{
...
{
  x \notin \dom(\mu) \\
  \mu, \varnothing, \mathcal{M}(x) \Rightarrow \mu', \rho
}
{
...
\inferrule*[lab={\ruleName{load-qualified}}]
{
  q.x \notin \dom(\mu) \\
  \mu, q \Rightarrow_{\mathsf{load}} \mu' \\
  \mu', \varnothing, \mathcal{M}(q.x) \Rightarrow \mu'', \rho
}
{

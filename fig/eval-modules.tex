...
\begin{subfigure}{\textwidth}
\flushleft \shadebox{$\mu, q \Rightarrow_{\mathsf{mod}} \mu', \rho$}
\begin{mathpar}
\small
...
{
  \mu, q \Rightarrow_{\mathsf{mod}} \mu', \rho
}
\end{mathpar}
...
{
  \varnothing, \pymath{\_\_main\_\_} \Rightarrow_{\mathsf{mod}} \mu, \rho
}
{
...
{
  x \notin \dom(\mu) \\
  \mu, x \Rightarrow_{\mathsf{mod}} \mu', \rho
}
{
...
\inferrule*[lab={\ruleName{load-qualified}}]
{
  q.x \notin \dom(\mu) \\
  \mu, q \Rightarrow_{\mathsf{load}} \mu' \\
  \mu', q.x \Rightarrow_{\mathsf{mod}} \mu'', \rho
}
{

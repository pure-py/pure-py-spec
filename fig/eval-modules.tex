...
\inferrule*[lab={\ruleName{eval-class}}]
{
  ...
  \mu, \rho \runion \set{c \mapsto C}, m \Rightarrow \mu', \rho'
}
{
  \mu, \rho, \exDataclass{c}{\phi} \cons m \Rightarrow \mu', \set{c \mapsto C} \runion \rho'
}
\and
...
{
  \mu, \rho, \exDataclassExtend{c}{c'}{\phi} \cons m \Rightarrow \mu', \set{c \mapsto C} \runion \rho'
}
\end{mathpar}

...
{
  \mu, x \Rightarrow_{\mathsf{load}} \mu' \runion \set{x \mapsto \exMod{\Gamma_x}{\set{\text{\pyinline{__name__}} \mapsto \rho_x^0(\text{\pyinline{__name__}})} \runion \rho}}
}
\and
...
{
  \mu, q.x \Rightarrow_{\mathsf{load}} \mu'' \runion \set{q.x \mapsto \exMod{\Gamma_{q.x}}{\set{\text{\pyinline{__name__}} \mapsto \rho_{q.x}^0(\text{\pyinline{__name__}})} \runion \rho}}
}
\end{mathpar}

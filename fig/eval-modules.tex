...
{
  \mu, \rho, \exImport{M} \cons m \Rightarrow \mu'', \set{x_1 \mapsto \mu'(x_1)} \runion \rho'
}
\and
...
{
  \mu, \rho, \exFromImport{M}{x_1, \ldots, x_{n+1}} \cons m \Rightarrow \mu'', \set{x_1 \mapsto \rho'(x_1), \ldots, x_{n+1} \mapsto \rho'(x_{n+1})} \runion \rho''
}
\and

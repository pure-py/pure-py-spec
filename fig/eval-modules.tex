...
{
  \varnothing, \rho_{\pymath{builtins}} \runion \set{\bind{\pymath{\_\_name\_\_}}{\pymath{"\_\_main\_\_"}}}, \mathcal{M}(q) \Rightarrow \mu, \rho
}
{
...
{
  \mu, x \Rightarrow_{\mathsf{load}} \mu' \runion \set{\bind{x}{\set{\bind{\pymath{\_\_name\_\_}}{\rho_x^0(\pymath{\_\_name\_\_})}} \runion \rho}}
}
\and
...
{
  \mu, q.x \Rightarrow_{\mathsf{load}} \mu'' \runion \set{\bind{q.x}{\set{\bind{\pymath{\_\_name\_\_}}{\rho_{q.x}^0(\pymath{\_\_name\_\_})}} \runion \rho}}
}
\end{mathpar}

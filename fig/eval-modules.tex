...
\begin{subfigure}{\textwidth}
\flushleft \shadebox{$\langle q_{\mathsf{e}}, \mathcal{M} \rangle \Rightarrow n$}
\begin{mathpar}
\small
\inferrule*[lab={\ruleName{eval-program}}]
{
  \varnothing, \rho_{q_{\mathsf{e}}}^0, \mathcal{M}(q_{\mathsf{e}}) \Rightarrow \mu, \rho
}
{
  \langle q_{\mathsf{e}}, \mathcal{M} \rangle \Rightarrow 0
}
\end{mathpar}
\subcaption{Program $\langle q_{\mathsf{e}}, \mathcal{M} \rangle$ evaluates to exit code $n$}
\end{subfigure}

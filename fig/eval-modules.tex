...
\inferrule*[lab={\ruleName{eval-import}}]
{
  ...
  \mu', \rho \runion \set{\bind{x_1}{\mu'(x_1)}}, m \Rightarrow \mu'', \rho'
}
{
...
{
  \mu, x \Rightarrow_{\mathsf{load}} \mu' \runion \set{\bind{x}{\exMod{\Gamma_x}{\set{\bind{\text{\pyinline{__name__}}}{\rho_x^0(\text{\pyinline{__name__}})}} \runion \rho}}}
}
\and
...
{
  \mu, q.x \Rightarrow_{\mathsf{load}} \mu'' \runion \set{\bind{q.x}{\exMod{\Gamma_{q.x}}{\set{\bind{\text{\pyinline{__name__}}}{\rho_{q.x}^0(\text{\pyinline{__name__}})}} \runion \rho}}}
}
\end{mathpar}

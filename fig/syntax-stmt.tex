...
$t$ & $::=$ & $\iota_1 \;\ldots\; \iota_m \;\; s_1 \;\ldots\; s_n$ & (ModuleBody)
   \\[3mm]
$q$ & $::=$ & ${\color{blue}x}$ & {\color{blue}(SimpleName)} \\
    & ${\color{blue}\mid}$ & ${\color{blue}\exAttr{q}{x}}$ & {\color{blue}(QualifiedName)} \\
    & & ${\color{deletedgray}x_1.x_2.\cdots.x_{n+1}}$ & {\color{deletedgray}(Name)}
   \\[3mm]

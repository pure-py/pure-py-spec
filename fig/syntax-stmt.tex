...
$s$ & $::=$ & $\exPass$ & (Pass) \\
    ...
    & $\mid$ & $\added{\exAnnAssign{x}{\tau}{e}}$ & \added{(AnnAssign)} \\
    & $\mid$ & $e$ & (ExprStmt) \\
...
$\phi$ & $::=$ & $\exField{x_1}{\replaced{\tau_1}{\pyinline{Any}}} \;\ldots\; \exField{x_{n+1}}{\replaced{\tau_{n+1}}{\pyinline{Any}}}$ & (FieldList) \\
...
$d$ & $::=$ & $\exDef{f}{x_1\added{\pi_1}, \ldots, x_n\added{\pi_n}}{\added{\omega}}{b}$ & (Def)
\end{tabular}
\end{center}

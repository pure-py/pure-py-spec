...
$s$ & $::=$ & $\exPass$ & (Pass) \\
    ...
    & \textcolor{deletedgray}{$\mid$} & \textcolor{deletedgray}{$\exImport{q}$} & \textcolor{deletedgray}{(Import)} \\
    & \textcolor{deletedgray}{$\mid$} & \textcolor{deletedgray}{$\exFromImport{q}{x_1, \ldots, x_{n+1}}$} & \textcolor{deletedgray}{(FromImport)}
   \\[3mm]
\textcolor{blue}{$\iota$} & \textcolor{blue}{$::=$} & \textcolor{blue}{$\exImport{q}$} & \textcolor{blue}{(Import)} \\
    & \textcolor{blue}{$\mid$} & \textcolor{blue}{$\exFromImport{q}{x_1, \ldots, x_{n+1}}$} & \textcolor{blue}{(FromImport)}
   \\[3mm]
...
$b$ & $::=$ & $s_1 \;\ldots\; s_{n+1}$ & (Block)
   \\[3mm]
$t$ & $::=$ & ${\color{blue}\iota_1 \;\ldots\; \iota_m} \;\; s_1 \;\ldots\; s_n$ & (ModuleBody)
   \\[3mm]

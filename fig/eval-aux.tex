...
\added{\elems(w)} &{}\added{{}= w_1 \ldots w_m} && \added{\text{where } w = w_1 \cons \ldots \cons w_m,\ \text{each } w_i \text{ one character}} \\
\\
\added{\iterOp(\delta)} &{}\added{{}= w_1 \ldots w_n} && \added{\text{where } \delta = \bind{w_1}{v_1} \cons \ldots \cons \bind{w_n}{v_n}} \\

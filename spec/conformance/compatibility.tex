...
statically\paperonly{ (\secref{no-coercions})}\speconly{ (summarised in the informative \annexref{exclusions})}. An implementation may report a dynamically excluded operation by raising

...
\PurePy (syntactically, statically or dynamically), or failing under Python.\paperonly{ \Added{\PurePy is also
designed so that every well-formed program is well typed under the mypy type checker, a requirement that
constrains the rules for variables, in particular how names are scoped (\secref{scope}).}}

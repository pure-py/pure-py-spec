...
assignment $\exAssign{\pymath{\_\_name\_\_}}{\nameOf(q)}$, modelling the binding of
$\pymath{\_\_name\_\_}$ that Python's import system makes before running the body.
...
\texttt{.py} file, or of its \texttt{\_\_init\_\_.py} for a package, preceded by the
$\pymath{\_\_name\_\_}$ assignment; a package directory without an \texttt{\_\_init\_\_.py} (a namespace
package, PEP 420, \url{https://peps.python.org/pep-0420/}) encodes that assignment alone. Prefix-closure
thus holds by construction.} The maps $\mathcal{M}$ and $\mathcal{P}$ are fixed and ambient in all

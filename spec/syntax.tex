...
and a module body $b$ is a statement or empty. A \emph{mutual region} $d_1 \ldots d_{n+1}$ is a maximal
...
$\seq{\iota}$ followed by an optional statement $b$; since imports are not statements, they can appear
neither within a statement (and hence not in function bodies) nor after the first statement. The
well-formedness and evaluation rules check and evaluate the body of each module $\mathcal{M}(q)$ with the

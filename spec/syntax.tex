...
and a module's statement $b$ is optional. A \emph{mutual region} $d_1 \ldots d_{n+1}$ is a maximal
...
neither within a statement (and hence not in function bodies) nor after it. The

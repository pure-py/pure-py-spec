...
package, PEP 420, \url{https://peps.python.org/pep-0420/}) encodes that assignment alone. Every directory on the
path to a module is therefore itself a module, so prefix-closure holds by construction.} The maps $\mathcal{M}$ and $\mathcal{P}$ are fixed and ambient in all

...
{
  \Sigma; \Gamma \override \set{\replaced{\bind{\seq{x}}{\seq{\tau}}}{\bind{x_1}{\tau_1}, \ldots, \bind{x_n}{\tau_n}}} \vdash e \checks \tau
}
{
  \Sigma; \Gamma \vdash \exLambda{\replaced{\seq{x}}{x_1, \ldots, x_n}}{e} \checks \replaced{\tyCallable{\seq{\tau}}{\tau}}{\tyCallable{\tau_1, \ldots, \tau_n}{\tau}}
}
\and
...
{
  \Sigma; \Gamma \vdash \exCall{(\exLambda{\replaced{\seq{x}}{x_1, \ldots, x_n}}{e})}{\replaced{\seq{e}}{e_1, \ldots, e_n}} \checks \tau
}
\and
...
{
  \Sigma; \Gamma \vdash \exList{\seq{e}} \checks \tyList{\tau}
}
\and
...
{
  \Sigma; \Gamma \vdash \exListComp{e}{\seq{g}} \checks \tyList{\tau}
}
\and
...
{
  \Sigma; \Gamma \vdash \exDictComp{e}{e'}{\seq{g}} \checks \tyDict{\tau}
}
\end{mathpar}
...
\end{mathpar}
\subcaption{Comprehension qualifiers $\seq{g}$ are well-formed and bind $\Delta$}
\end{subfigure}

...
{
  \added{\Sigma; \Gamma; \zeta \vdash x\exAnnot{\psi} : \Assigns{\set{\bind{x}{\DeclTy{\tau}}}}}
}
\and
\inferrule*[lab={\ruleName{assign}}]
{
  \added{\Gamma(x) = \DeclTy{\tau}} \\
...
\and
\inferrule*[lab={\ruleName{assign-annot}}]
{
  \added{\Gamma(x) = \Unbound} \\
...
\inferrule*[lab={\ruleName{seq}}]
{
  ...
  \deleted{\capturesS(s) \cap \assignsS(s') = \varnothing}
}
{
...
{
  \added{\Gamma(f_i) = \Unbound \quad (\forall i)} \\
  \added{\declaresS(s_i) \text{ distinct} \quad (\forall i)} \\

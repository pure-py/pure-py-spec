...
{
  \added{\seq{x}_i \text{ distinct} \quad (\forall i)} \\
  ...
  \Sigma; \Gamma \override \Delta' \override \Delta_i \override \replaced{\scopeS(\set{\seq{x}_i}, s_i)}{\set{\bind{x}{\Unbound} \mid x \in \assignsS(s_i) \setminus \dom(\Delta_i)}}; \tau_i \vdash s_i : R_i \quad (\forall i)
  \\

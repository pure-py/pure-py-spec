...
{
  \added{\Gamma(f_i) = \Decl \quad (\forall i)} \\
  ...
  \Sigma; \Gamma \override \Delta' \override \Delta_i \override \set{\bind{x}{\Decl} \mid x \in \assignsS(s_i) \setminus \dom(\Delta_i)}; \tau_i \vdash s_i : R_i \quad (\forall i)
  \\

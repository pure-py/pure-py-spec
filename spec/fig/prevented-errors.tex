...
\pyinline{TypeError} & The operation is a constructor call or class pattern, which must match the class's arity exactly. (Only excess sub-patterns are a Python error; a pattern with fewer is excluded even though Python permits it.) & \figref{typing-synth}, \figref{well-formed-pat}
\end{tabular}

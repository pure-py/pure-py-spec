...
\inferrule*[lab={\ruleName{syn-list}}]
{
  ...
  \tau = \joinTy(\widen(\tau_i) \mid i \in I) \\
...
{
  \Gamma \vdash \exListComp{e}{g_1\;\ldots\;g_n} \synth \tyList{\widen(\tau)}
}
\and
...
{
  \Gamma \vdash \exDictComp{e}{e'}{g_1\;\ldots\;g_n} \synth \tyDict{\widen(\tau)}
}
\end{mathpar}

...
{
  \Sigma; \Gamma \vdash e \synth \replaced{\tyCallable{\seq{\tau}}{\tau}}{\tyCallable{\tau_1, \ldots, \tau_n}{\tau}} \\
  \replaced{\Sigma; \Gamma \vdash \seq{e} \checks \seq{\tau}}{\Sigma; \Gamma \vdash e_i \checks \tau_i \quad (\forall i)}
}
{
  \Sigma; \Gamma \vdash \exCall{e}{\replaced{\seq{e}}{e_1, \ldots, e_n}} \synth \tau
}
\and
\inferrule*[lab={\ruleName{syn-call-lambda}}]
{
  \replaced{\Sigma; \Gamma \vdash \seq{e} \synth \seq{\tau}}{\Sigma; \Gamma \vdash e_i \synth \tau_i \quad (\forall i)} \\
  \Sigma; \Gamma \override \set{\replaced{\bind{\seq{x}}{\seq{\tau}}}{\bind{x_1}{\tau_1}, \ldots, \bind{x_n}{\tau_n}}} \vdash e \synth \tau
}
{
  \Sigma; \Gamma \vdash \exCall{(\exLambda{\replaced{\seq{x}}{x_1, \ldots, x_n}}{e})}{\replaced{\seq{e}}{e_1, \ldots, e_n}} \synth \tau
}
\and
\inferrule*[lab={\ruleName{constr}}]
{
  \Gamma \vdash q : \Type{C} \\
  \added{\fields(\Sigma, C) = \bind{\seq{x}}{\seq{\tau}}} \\
  \added{\fieldMap(\Sigma, C, a) = \set{\bind{\seq{x}}{\seq{e}}}} \\
  \replaced{\Sigma; \Gamma \vdash \seq{e} \checks \seq{\tau}}{\Sigma; \Gamma \vdash \fieldMap(\Sigma, C, a)(x) \checks \tau \quad (\forall \bind{x}{\tau} \in \fields(\Sigma, C))}
}
{
...
\inferrule*[lab={\ruleName{binop}}]
{
  ...
  \Sigma; \Gamma \vdash e' \synth \sigma' \\
  \replaced{\resolveOp(\Sigma, \odot, \sigma, \sigma') = \tau^\dagger}{\min(\overloadsOf(\Sigma, \odot, \sigma, \sigma')) = ((\tau, \tau'), \tau^\dagger)}
}
{
...
\inferrule*[lab={\ruleName{unop}}]
{
  ...
  \replaced{\resolveOp(\Sigma, \ominus, \sigma) = \tau^\dagger}{\min(\overloadsOf(\Sigma, \ominus, \sigma)) = (\tau, \tau^\dagger)}
}
{
...
{
  \Sigma; \Gamma \vdash e \synth \replaced{\tyTuple{\tau_1, \ldots, \tau_m}}{\tyTuple{\seq{\tau}}} \\
  \Sigma; \Gamma \vdash e' \synth \tyLiteral{n} \\
  0 \leq n < \replaced{m}{|\seq{\tau}|}
}
{
...
\inferrule*[lab={\ruleName{syn-list-comp}}]
{
  ...
  \replaced{\captures}{\capturesE}(e) \cap \dom(\Delta) = \varnothing
}
{
...
\inferrule*[lab={\ruleName{syn-dict-comp}}]
{
  ...
  \Sigma; \Gamma \override \Delta \vdash e' \synth \tau \\
  \replaced{\captures}{\capturesE}((e, e')) \cap \dom(\Delta) = \varnothing
}
{

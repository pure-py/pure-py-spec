...
\inferrule*[lab={\ruleName{syn-list}}]
{
  ...
  \Gamma \vdash e_j \checks \joinTy(\baseType(\sigma_i) \mid i \in I) \quad (\forall j \notin I)
}
{
  \Gamma \vdash \exList{e_1, \ldots, e_{n+1}} \synth \tyList{\joinTy(\baseType(\sigma_i) \mid i \in I)}
}
\and
...
{
  \Gamma \vdash \exDict{\bind{e_1}{e_1'}, \ldots, \bind{e_{n+1}}{e_{n+1}'}} \synth \tyDict{\joinTy(\baseType(\sigma_i) \mid i \in I)}
}
\and

...
\inferrule*[lab={\ruleName{binop}}]
{
  ...
  \Gamma \vdash e' \synth \sigma' \\
  \min(\overloadsOf(\odot, \sigma, \sigma')) = ((\tau, \tau'), \tau^\dagger)
}
{
  \Gamma \vdash \exBinOp{e}{\odot}{e'} \synth \tau^\dagger
}
\and
\inferrule*[lab={\ruleName{unop}}]
{
  ...
  \min(\overloadsOf(\ominus, \sigma)) = (\tau, \tau^\dagger)
}
{
  \Gamma \vdash \exUnOp{\ominus}{e} \synth \tau^\dagger
}
\and

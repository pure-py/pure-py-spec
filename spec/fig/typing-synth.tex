...
{
  \Gamma \vdash e \synth \tyTuple{\seq{\tau}} \\
...
{
  \Gamma \vdash \exSubscript{e}{e'} \synth \joinTy(\seq{\tau})
}
\and
...
\end{mathpar}
\caption{Expression synthesis, elimination forms}
...
\end{mathpar}
\caption{Expression synthesis, container forms}

...
{
  \Gamma \vdash \exList{e_1, \ldots, e_{n+1}} \synth \tyList{\joinTy(\tau_1, \ldots, \tau_{n+1})}
}
\and
...
{
  \Gamma \vdash \exDict{\bind{e_1}{e_1'}, \ldots, \bind{e_{n+1}}{e_{n+1}'}} \synth \tyDict{\joinTy(\tau_1, \ldots, \tau_{n+1})}
}
\and

...
\inferrule*[lab={\ruleName{syn-cond}}]
{
  ...
  \Sigma; \Gamma \vdash e_j \checks \bigJoinTy{\Sigma}{(\sigma_i)_{i \in I}} \quad (\forall j \notin I)
}
{
  \Sigma; \Gamma \vdash \exCondExpr{e_1}{e}{e_2} \synth \bigJoinTy{\Sigma}{(\sigma_i)_{i \in I}}
}
\and
...
{
  I = \set{i \mid \Sigma; \Gamma \vdash e_i \synth \sigma_i} \neq \varnothing \\
  \tau = \bigJoinTy{\Sigma}{(\baseType(\sigma_i))_{i \in I}} \\

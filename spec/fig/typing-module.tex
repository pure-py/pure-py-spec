...
\inferrule*[lab={\ruleName{module}}]
{
  ...
  \replaced{\Sigma^\dagger}{\Sigma_1}; q; \replaced{\Gamma}{\Gamma'} \override \replaced{\Gamma'}{\Gamma} \mathbin{\added{\override}} \added{\scopeS(\set{\declaresS(\seq{\iota})}, t)} \vdash t : \Assigns{\Delta} \binding \Sigma' \\

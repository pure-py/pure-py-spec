...
\inferrule*[lab={\ruleName{module}}]
{
  ...
  \Sigma; q \vdash \seq{\iota} : \Gamma \binding \replaced{\Sigma^\dagger}{\Sigma_1} \\
  \mathcal{P}(\pyinline{builtins}) = (\Gamma', \rho) \\
  \replaced{\Sigma^\dagger}{\Sigma_1}; q; \Gamma' \override \Gamma \mathbin{\added{\override}} \added{\set{\bind{x}{\Unbound} \mid x \in \assignsS(t)}} \vdash t : \Assigns{\Delta} \binding \Sigma' \\

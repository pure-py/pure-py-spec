...
\inferrule*[lab={\ruleName{module}}]
{
  ...
  \added{\declaresS(t) \text{ distinct}} \\
  \added{\set{\declaresS(t)} \cap (\dom(\Gamma) \cup \binds(t)) = \varnothing} \\
  \Sigma_1; q; \Gamma' \override \added{\set{\bind{x}{\Unbound} \mid x \in \assignsS(t)}} \mathbin{\added{\override}} \Gamma \vdash t : \Assigns{\Delta} \binding \Sigma' \\

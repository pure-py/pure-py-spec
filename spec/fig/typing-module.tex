...
\inferrule*[lab={\ruleName{from-import}}]
{
  ...
  \set{q^\dagger_1, \ldots, q^\dagger_m} = \set{q^\dagger \properPrefixOf q' \mid q^\dagger \not\prefixOf q} \\
  q^\dagger_1 \properPrefixOf \cdots \properPrefixOf q^\dagger_m \\
...
{
  \Sigma \vdash_{\mathsf{load}} q : \Gamma' \binding \Sigma^\dagger \\
  \Sigma^\dagger \vdash q, \modLoaded{q}{\Gamma' \extend \set{\bind{x}{\theta}}} \loadsAs \theta' \binding \Sigma'
}
{
...
\inferrule*[lab={\ruleName{module}}]
{
  ...
  \Sigma^\dagger; q; \Gamma \override \Gamma' \mathbin{\override} \scopeS(\set{\declaresS(\seq{\iota})}, t) \vdash t : \Assigns{\Delta} \binding \Sigma' \\

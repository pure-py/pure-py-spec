...
\inferrule*[lab={\ruleName{module}}]
{
  ...
  \replaced{\Sigma^\dagger}{\Sigma_1}; q; \Gamma' \override \added{\set{\bind{x}{\Unbound} \mid x \in \assignsS(t)}} \mathbin{\added{\override}} \Gamma \vdash t : \Assigns{\Delta} \binding \Sigma' \\

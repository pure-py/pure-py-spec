...
{
  \Sigma; q; \Gamma \vdash t : \Assigns{\Delta} \binding \replaced{\Sigma^\dagger}{\Sigma'} \\
  \replaced{\Sigma^\dagger}{\Sigma'}; q; \Gamma \override \Delta \vdash t' : R \binding \replaced{\Sigma'}{\Sigma^\dagger} \\
  \deleted{\captures(t) \cap \assignsS(t') = \varnothing} \\
  \deleted{c \notin \assignsS(t') \quad (\forall \bind{c}{\Type{C}} \in \Delta)}
}
{
  \Sigma; q; \Gamma \vdash t\;t' : \Assigns{\Delta} \override R \binding \replaced{\Sigma'}{\Sigma^\dagger}
}
\and

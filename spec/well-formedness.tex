...
names of a module, to be distinct from one another and from its pattern variables. A name therefore cannot be declared twice in a scope,
...
another and from its pattern variables. The function names of the mutual region are not among these; they are
...
from its pattern variables.}{overridden by the imported context, so the members of \pyinline{builtins} are in scope
unqualified.}

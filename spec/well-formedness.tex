...
\ruleName{list-comp}, \ruleName{dict-comp} and \ruleName{qual-generator}, because Python closures are
late-binding and the comprehension rebinds the variable on each iteration, so the lambda would see the
variable's final value. A lambda applied to the generator variable receives the variable's value at
that iteration. A module attribute reference

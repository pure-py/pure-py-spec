...
the class name to $\Type{C}$, requiring the class's own fields to be distinct and, when it extends
...
mutual region, including its own name, each at the appropriate $\pyinline{Callable}$ type; variables assigned in the body start

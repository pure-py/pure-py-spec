...
inferred from its body. Within a type expression, class names resolve to classes, type parameters in scope denote the type variables of those names, and all other names must be predefined names (\figref{resolve-type}). The function $\baseType(\tau)$ discards the precision of a
...
another class, the base name to be bound to a class, applied to as many type arguments as that class has parameters, and the additional fields not to repeat an inherited field

...
(\figrefTwo{pat}{pat-seq}). Reachability is decided by the shapes a case matches and exhaustiveness
by the residual left by the last case. Each element of this design has a precedent. Deciding both properties with a single
relation goes back to the (``usefulness'') algorithm for ML~\cite{maranget2007}. The residual plays
the role of the term descriptions that the match compiler of \citet{sestoft1996} threads through the
cases. Seeding the match with the scrutinee's type follows the uncovered sets of

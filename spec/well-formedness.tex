...
\ruleName{module} require the declarations of a scope, its parameters or imported names among them, to be
distinct from one another and from its pattern variables. A name therefore cannot be declared twice in a scope,
...
prefers a locally \Replaced{bound}{assigned} name to one visible in an enclosing scope. \Added{As with any scope, the declarations of the function, its parameters among them, must be distinct from one
...
scope, the declarations of the module, its imported names among them, must be distinct from one another and

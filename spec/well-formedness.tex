...
\Replaced{A mutual region of function definitions (\ruleName{def}) gives each definition its \pyinline{Callable} type
from its annotations (\ruleName{def-signature}, \figref{typing-def}), binds the names of the mutual region,

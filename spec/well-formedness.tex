...
parameters joined and results combined using meet, and is \pyinline{Never} otherwise, since no value belongs to both types. A sequence of types is joined by

...
bound to a class, module or predefined name cannot be assigned at all. The declaration rules do not consult the context entry of the variable; instead \ruleName{def} and

...
bound to a class, module or predefined name cannot be assigned at all. The declaration rules place no condition on the entry of the variable; instead \ruleName{def} and

...
so a variable of the enclosing scope that the body references must be definitely assigned at that point. Since
...
\Replaced{overridden by $\Unbound$ for each name the body binds and then by the imported context, so the members of

...
over-approximation of the values of $\sigma$ which are not matched by earlier cases
...
ordered set of \emph{shapes} (\figref{shapes}) drawn from the scrutinee's type and covering every value not matched by

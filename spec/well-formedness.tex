...
bound to a class, module or predefined name cannot be assigned at all. The declaration rules do not consult the context for the variable they declare; instead \ruleName{def} and

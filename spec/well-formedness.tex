...
variable's final value. In \PurePy a lambda applied to the generator variable receives the variable's
value at that iteration. A module attribute reference

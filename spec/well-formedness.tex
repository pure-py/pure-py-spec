...
name, pattern variable or other declaration, since mypy rejects such reuse as a redefinition, whereas a name may shadow
a name of an enclosing scope or builtin, which mypy permits.}

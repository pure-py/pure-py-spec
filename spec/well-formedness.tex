...
\figref{shape-tries} sketches a type-indexed trie to replace shape sets, with a default branch
in place of excluded heads (\issue{186}).

\input{spec/fig/shape-tries}

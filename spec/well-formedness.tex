...
twice in a scope, whether on one path or in different branches, nor declared over a parameter, an imported
name or a pattern variable, as mypy requires. The body of a lambda or nested definition is checked under the context in force where it is defined,

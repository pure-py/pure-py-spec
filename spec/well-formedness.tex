...
\ruleName{module} require the declarations of a scope, including the parameters of a function or the imported
names of a module, to be distinct from one another and from any pattern variables in the scope. A name therefore cannot be declared twice in a scope,

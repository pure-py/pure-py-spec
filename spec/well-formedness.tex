...
typing $\Sigma \vdash h : \tau$ holds when the values of $h$ lie within $\tau$. A shape is typed at
$\tau$, $\Sigma \vdash k : \tau$, when each of its excluded heads is typed at $\tau$ and each of its
component shapes at the type of that component. The other forms are constructors, tuples, lists and dictionaries, each with shapes in place of

...
$\Sigma \vdash k : \tau$ checks each excluded head and each component of a shape. The other forms are literals, constructors, tuples, lists and dictionaries, each with shapes in place of

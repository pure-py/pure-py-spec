...
shape, giving the matched shapes $K$, the residual $L$ and the bindings $\Delta$; the form on sequences
...
matches each shape of $L$ in turn. A pattern has no derivation against a shape it is unable to match, so

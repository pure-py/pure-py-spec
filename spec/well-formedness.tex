...
whether its name is already declared; that check is made once for the whole scope, by the rules for function
definitions and modules ($\wellScoped$, \paperonly{\figref{auxiliary-functions}}\speconly{\S\ref{aux:well-scoped}}).}{An annotated assignment checks the expression against the type of the annotation,

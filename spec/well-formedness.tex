...
whether its name is already declared. That check is made once for the whole scope: the rules for function
definitions and modules require the scope to be well-scoped
(\paperonly{\figref{auxiliary-functions}}\speconly{\S\ref{aux:well-scoped}}), meaning that the names declared in
it, including the parameters of a function or the imported names of a module, are distinct from one another and
from any pattern variables in the scope. The body of a lambda or nested definition

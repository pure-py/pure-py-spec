...
from any pattern variables in the scope. A variable of the enclosing scope referenced by the body of a lambda
or nested definition must be definitely assigned where the lambda or definition occurs, whereas Python resolves
the reference only when the body runs.}{An annotated assignment checks the expression against the type of the annotation,

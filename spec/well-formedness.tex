...
\pyinline{return} \Replaced{requires \pyinline{None} to be a subtype of $\tau$}{requires $\tau$ to admit \pyinline{None}}. \Replaced{A bare annotation declares a variable at the type
of its annotation, without assigning it (\ruleName{declare}); an assignment requires the variable to be
...
assigned on some path is possibly unassigned after the merge, as a blank final in Java~\cite[\S16]{gosling2025}, and a

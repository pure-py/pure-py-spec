...
empty and \ruleName{split-tuple} leaves nothing.
...
$\beta$ with a value of shape $\beta(w)$, but that hold no key of $H$. A dictionary pattern takes its keys in order, no key twice. A key in

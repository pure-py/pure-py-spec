...
A pattern matches a shape directly if the shape has the head tested by the pattern, and otherwise splits it first (\figref{split}): splitting takes the head

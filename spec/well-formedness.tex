...
that join (\ruleName{syn-cond}), tuples when every component synthesises, comprehensions
when the body synthesises, and non-empty lists and dictionaries when at least one element

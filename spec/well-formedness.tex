...
enclosing scope referenced by the body must be definitely assigned where the function is defined, whereas Python
resolves the reference only when the body runs. As with any scope, the names declared in the function, including

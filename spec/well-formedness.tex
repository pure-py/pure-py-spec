...
prefers a locally \Replaced{bound}{assigned} name to one visible in an enclosing scope. \Added{The parameters and the names declared in a body must be distinct, and none of them may be bound by a
pattern in the body, as mypy requires; the names of the region are declarations of the enclosing scope.} The body is checked with the

...
$\Delta$, which may be empty. \Replaced{The base cases are that $\exReturn{e}$ definitely returns, that
$x\exAnnot{\psi}$ definitely assigns $\set{\bind{x}{\DU{\tau}}}$, and that $\exAssign{x}{e}$ and
$\exAssign{x\exAnnot{\psi}}{e}$ definitely assign $\set{\bind{x}{\tau}}$, for the type $\tau$ denoted by

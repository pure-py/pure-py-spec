...
well-formedness rule for $\pyinline{match}$ (\figref{well-formed}) to rule out unreachable cases and to check exhaustiveness; with
the current pattern set, the latter reduces to requiring a catch-all (var or wildcard) case.

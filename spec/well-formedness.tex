...
permitted, it may declare a name of an enclosing body or a builtin. A pattern introduces its variables rather
than assigning them, so a pattern cannot bind a name declared in its scope either, although several cases of
one match may bind the same variable.}

...
\Replaced{overridden by $\Unbound$ for each name bound by the body and then by the imported context, so the members of
\pyinline{builtins} are in scope unqualified and a name bound by the body shadows a builtin throughout. As with any

...
prefers a locally \Replaced{bound}{assigned} name to one visible in an enclosing scope. \Added{As with any scope, the parameters together with the names declared in the body must be distinct and not
...
scope, the imported names together with the names declared by the body must be distinct and not bound by a
pattern in the body.}{overridden by the imported context, so the members of \pyinline{builtins} are in scope
unqualified.}

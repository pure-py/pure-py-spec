...
variable's final value. In \PurePy a lambda sees only the value of the generator variable at each
iteration, passed by application. A module attribute reference

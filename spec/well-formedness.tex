...
$\Assigns{\varnothing}$ for the values that fall through.
...
residual denotes the values of the scrutinee's type which are not matched by earlier cases. Matching the case removes from the residual the values matched

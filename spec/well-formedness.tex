...
(\figref{typing-check}). A generator's variable is bound at $\elemTy$ of the type the iterated
expression synthesises (\secref{types-auxiliary}), the static counterpart of $\iterOp$

...
\speconly{\input{spec/well-formedness/variable-aims}
\Added{For the second, a scope is the body of a module, function, lambda or comprehension, as in Python, and the
...
\ruleName{module} require the scope to be well-scoped (\paperonly{\figref{auxiliary-functions}}\speconly{\S\ref{aux:well-scoped}}): the names declared in the scope, including the parameters of a function or the imported
...
prefers a locally \Replaced{bound}{assigned} name to one visible in an enclosing scope. \Added{As with any scope, the names declared in the function, including its parameters, must be distinct from one
...
scope, the names declared in the module, including its imported names, must be distinct from one another and

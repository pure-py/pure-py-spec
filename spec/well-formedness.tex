...
\pyinline{x = e} definitely assigns \Replaced{$\set{\bind{\pyinline{x}}{\tau}}$ for the declared type $\tau$ of
\pyinline{x}.}{$\set{\bind{\pyinline{x}}{\sigma}}$ for the type $\sigma$ of
\pyinline{e}.} \Replaced{A \emph{static outcome} $R$ records which of the two holds: $\Returns$, for definitely returns, or

...
pattern $p$; and $\capturesS(s)$, the set of variables from the enclosing scope that are captured by lambdas
and nested function definitions within $s$, with companion $\capturesE(e)$ on expressions.

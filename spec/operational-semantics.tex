...
Whether a pattern matches is determined by the deterministic pattern-matching judgement
$\rho, p, v \matches m$\speconly{ (\figref{match})}. A \emph{match result} $m$ is either $\matchOk{\rho'}$, a match binding

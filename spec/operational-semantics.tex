...
\figref{eval-imports}.}\paperonly{Module and program evaluation are given in full in \specification.} Context extension (Definition~\ref{def:extend}) applies to module values as well, reading its equations with a loaded reference $\modLoaded{q}{\rho}$ carrying an environment in place of a context. The loading judgement $q \Rightarrow_{\mathsf{load}} o$ evaluates the import prefix

...
possibility, distinct from both match results: where a pattern and a value are not comparable, as a list
pattern against a tuple, \PurePy can say neither that they match nor that they do not, and gives the run
no result. Sub-results compose with $\override$, matching
sequentially:
{\small
\begin{align*}

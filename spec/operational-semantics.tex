...
string by an integer, counting from the end when negative, and a dictionary by a string key, with
Python's \pyinline{IndexError}, \pyinline{KeyError} and \pyinline{TypeError}; a dictionary subscripted by a
value other than a string is undefined.

...
function $\iterOp$ (\paperonly{\figref{auxiliary-functions}}\speconly{\S\ref{aux:iter}}) gives for a list, tuple or
string, and for a dictionary as its keys, as in Python. These are the only values a generator can draw from.

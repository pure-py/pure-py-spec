...
concatenates the results; a generator draws its bindings from the elements of a value, which the auxiliary
function $\iterOp$ (\paperonly{\figref{auxiliary-functions}}\speconly{\S\ref{aux:iter}}) gives: the elements of a
list, tuple or string, and the keys of a dictionary, as in Python. These are the only values a generator can draw from.

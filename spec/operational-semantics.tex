...
the scope of sequential-composition effects, so as black boxes functions are always pure. The auxiliary function $\outcome$\speconly{ (\S\ref{aux:outcome})} reads a block's result as
the outcome of calling it\speconly{, $\val{\pyinline{None}}$ where the block falls off the end.}\paperonly{:}

...
\figref{eval-imports}.}\paperonly{Module and program evaluation are given in full in \specification.} Extend (Definition~\ref{def:extend}) extends to module values by reading its equations with a loaded reference $\modLoaded{q}{\rho}$ carrying an environment in place of a context. The loading judgement $q \Rightarrow_{\mathsf{load}} o$ evaluates the import prefix

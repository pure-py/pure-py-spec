...
Whether a pattern matches is determined by the pattern-matching judgement $\rho, p, v \matches m$\speconly{ (\figref{match})}, which is
deterministic. A \emph{match result} $m$ is either $\matchOk{\rho'}$, a match binding

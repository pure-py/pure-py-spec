Result type of the least overload of an operator at the operand types. The overloads of $\odot$ at $(\sigma_1, \sigma_2)$
...
The least overload under this order exists when some overload applies and neither operand type is below
\pyinline{Never} (Lemma~\ref{lem:least-overload}); otherwise the function is undefined.

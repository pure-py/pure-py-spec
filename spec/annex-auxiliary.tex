...
\begin{auxfunction}{\fv(e), \fv(\seq{e})}{set of variables}{aux:fv}
...
\begin{auxfunction}{\fields(\Sigma, C)\added{, \fields(\Sigma, C[\seq{\tau}])}}{sequence of bindings}{aux:fields}
\input{spec/functions/fields-text}
\funcrows{fields}
\end{auxfunction}

\begin{auxfunction}{\ancestors(\Sigma, C)\added{, \ancestors(\Sigma, C[\seq{\tau}])}}{set of classes\added{ or of instantiated classes}}{aux:ancestors}

...
\begin{auxfunction}{\fields(\Sigma, C)}{\replaced{field scheme}{sequence of bindings}}{aux:fields}
...
\begin{auxfunction}{\contains(v, v')}{Boolean}{aux:contains}
\input{spec/functions/contains-text}
\funcrows{contains}
\end{auxfunction}

\begin{auxfunction}{\containsElems(\seq{v}, v)}{Boolean}{aux:contains-elems}

...
% (if or where) goes in the condition column; a row too wide for that has its condition on a
...
\begin{auxfunction}{\binds(p)\added{, \binds(s)}}{set of variables}{aux:binds}
...
\input{spec/functions/declares-text}
\funcrows{declares}
\end{auxfunction}

\begin{auxfunction}{\wellScoped(Y, s)}{Boolean}{aux:well-scoped}
\input{spec/functions/well-scoped-text}
\funcrows{well-scoped}
\end{auxfunction}
\end{AddedBlock}

\begin{auxfunction}{\replaced{\captures}{\capturesE}(e)}{set of variables}{aux:captures-e}
\input{spec/functions/captures-e-text}
\funcrows{captures-e}
\end{auxfunction}

\begin{auxfunction}{\captures(\replaced{\seq{g}}{t})}{set of variables}{aux:captures}
...
\begin{auxfunction}{\fvE(e)\added{, \fvE(\seq{e})}}{set of variables}{aux:fv-e}
...
\input{spec/functions/resolve-op-text}
\funcrows{resolve-op}
\end{auxfunction}
\end{AddedBlock}
...
\input{spec/functions/setitem-text}
\funcrows{setitem}
\end{auxfunction}

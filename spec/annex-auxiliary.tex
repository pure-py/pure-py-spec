...
\begin{auxfunction}{\fields(\Sigma, C)}{\replaced{scheme over bindings}{sequence of bindings}}{aux:fields}
\input{spec/functions/fields-text}
\funcrows{fields}
\end{auxfunction}

\begin{auxfunction}{\ancestors(\Sigma, C)}{\replaced{scheme over instantiated classes}{set of classes}}{aux:ancestors}

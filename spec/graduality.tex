...
Concretisation and abstraction form a \emph{Galois insertion}: $\alpha(S) \precTy \gty{\tau}$ if and
only if $S \subseteq \gamma(\gty{\tau})$, and $\alpha(\gamma(\gty{\tau})) = \gty{\tau}$, because by

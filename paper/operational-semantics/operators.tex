...
the same keys by their values, and objects of the same class by their fields; \pyinline{None} is comparable
...
\pyinline{nan}s inside a container. Compared directly, \pyinline{nan == nan} is \pyinline{False} in both languages,
...
function $\contains$ tests for a key of a dictionary, a substring of a string, or an element of a list or tuple,

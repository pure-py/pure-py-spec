...
dependency static: a \emph{mutual region}, \Replaced{a maximal non-empty sequence of consecutive \pyinline{def} statements}{a maximal run of consecutive \pyinline{def} statements in a sequence} (\figref{syntax-stmt}), is a single simultaneous binding. The \ruleName{def} rule checks each body in a

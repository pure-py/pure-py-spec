...
already. The \ruleName{declare} rule binds the variable at $\DeclTy{\tau}$, declared at $\tau$ but not
...
or assigned by the body, $\assignsS(s)$, at $\Decl$ before checking the body, so a reference before the

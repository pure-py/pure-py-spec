...
dependency static: a \emph{mutual region}, a maximal contiguous block of \pyinline{def} statements (\figref{syntax-stmt}), is a single simultaneous binding. The \ruleName{def} rule checks each body in a

...
the module. \PurePy treats the builtins as an enclosing scope like any other, and therefore rejects a module that
uses a builtin name before declaring that name. A pattern introduces its variables rather than assigning them, so a pattern

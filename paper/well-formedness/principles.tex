...
\Replaced{This section introduces the concepts on which the rules depend, each with the programs it admits and
rejects; the rules follow in \secref{expression-typing} to \secref{well-formedness-modules}.}{Well-formedness
...
already, the rule Java applies to blank finals~\cite[\S16]{gosling2025}. The \ruleName{declare} rule binds the variable at $\DU{\tau}$, declared at $\tau$ and

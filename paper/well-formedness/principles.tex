...
branch that does not definitely return assigns it, otherwise leaving it at $\statusNotDefAssigned$
...
only if every case binds it or returns. A match whose cases leave some value of the scrutinee's type

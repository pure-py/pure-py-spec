...
\pyinline{nan}s. Python gives an answer in each case (\figref{coercions}), so each is a dynamically excluded
comparison. Comparison stops at the first element that

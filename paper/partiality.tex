...
Python gives an answer in each case (\figref{coercions}), so each is a dynamically excluded comparison. Comparison stops at the first element that
...
function $\memOp$ is defined through equality and stops in the same way. The strict operators are given by

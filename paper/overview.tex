...
its generator variables in place on each iteration, so a lambda within a comprehension may not capture one, since
the updates would otherwise be visible through the lambda (\secref{captured-variables}):}{Reassignment of a variable already

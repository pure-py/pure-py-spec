...
A variable in \PurePy denotes a fixed value once definitely assigned, so features that update values in place or
rebind variables are excluded: \pyinline{global} and \pyinline{nonlocal}, which make assignments rebind a variable of an enclosing scope;

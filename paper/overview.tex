...
\replaced{\PurePy requires every variable to be declared with a type annotation (\secref{well-formedness}).}{This motivates the definite-assignment analysis (\secref{well-formedness}).}}
...
\Replaced{A variable in \PurePy is declared once and assigned at most once on any path (\secref{local-assignment}),
so it denotes a fixed value once assigned, and}{A variable in \PurePy denotes a fixed value once definitely

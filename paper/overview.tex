...
\begin{tikzpicture}[font=\footnotesize, rounded corners=4pt, yscale=0.7]
  \fill[cyan!60, fill opacity=0.13] (4.8,0.5) rectangle (12.95,6.5);
  \fill[cyan!60, fill opacity=0.13] (1.5,1.0) rectangle (9.0,5.5);
  \fill[green!14] (5.2,1.9) rectangle (8.8,4.5);
  \draw[black!33, line width=0.7pt] (0,0) rectangle (13.4,7.0);
  \draw[cyan!72!black, line width=0.7pt] (1.5,1.0) rectangle (9.0,5.5);
  \draw[dashed, cyan!72!black, line width=0.7pt] (4.8,0.5) rectangle (12.95,6.5);
  \draw[green!58!black, line width=0.7pt] (5.2,1.9) rectangle (8.8,4.5);
  \node[anchor=north west, align=left] at (0.15,6.85) {\textbf{Syntactically valid Python}\\Python runtime error (\figref{prevented-errors})};
  \node[anchor=north east, align=right] at (12.8,6.4) {\textbf{Semantically valid Python}\\no runtime error};
  \node[anchor=north west] at (1.65,5.35) {\textbf{Well-formed \PurePy}};
  \node[align=center] at (11.0,3.3) {Statically excluded\\(\figref{coercions})};
  \node[align=center] at (3.2,3.25) {\PurePy runtime error};
  \node[align=center] at (6.9,5.0) {Dynamically excluded\\(\figref{coercions})};
  \node[align=center] at (7.0,3.2) {\textbf{Semantically valid}\\\textbf{\PurePy}\\[1mm]Same result as Python};
\end{tikzpicture}

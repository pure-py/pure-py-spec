...
Static Python~\cite{lu2023} is a gradually typed dialect of Python used in production at Instagram,
combining concrete and transient enforcement so that typed code is sound. \PurePy adopts a static
type system whose well-typed programs mypy accepts, leaving gradual typing to a later release.

...
introduces a function, so a variable \pyinline{def} is a syntax error; core \PurePy, a subset of Python, has no such
form either. The implicit definitions of the core are the case in which every variable is introduced by

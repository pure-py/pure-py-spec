...
which late binding then makes the target of the call in \pyinline{f}. Finally, the branches of a conditional may contain regions of their own, subject to the usual

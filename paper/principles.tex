...
scope after the \pyinline{match} statement. \PurePy follows, treating each case as a branch that assigns
the variables its pattern binds. The set of variables a pattern $p$ introduces is $\binds(p)$; the

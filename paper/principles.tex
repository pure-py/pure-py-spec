...
which late binding then makes the target of the call in \pyinline{f}. A branch of a conditional may contain regions of its own, subject to definite assignment as

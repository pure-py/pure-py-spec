...
\versionstring{} of the standard, whose full specification is included as supplementary material.}: a formal grammar, well-formedness rules based on a
...
exercised on CPython,  GraalPy, and Pyodide (\secref{reference-impl});

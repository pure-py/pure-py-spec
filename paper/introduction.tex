...
programs are accepted by mypy, and an operational semantics that agrees with Python on every run that it defines. A reference checker decides well-formedness, and a conformance test suite exercises the

...
formal grammar, a type system that accepts only programs accepted by mypy, and an operational semantics
...
\input{paper/overview}
\input{spec/syntax}
\input{spec/well-formedness}
\input{spec/operational-semantics}
\input{paper/reference-implementation}
\input{paper/extensions}
